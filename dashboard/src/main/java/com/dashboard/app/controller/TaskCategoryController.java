...
import com.dashboard.app.service.TaskCategoryService;
...
public class TaskCategoryController {
    ...
    public ResponseEntity<List<CategoryResponse>> getAll() {
        return ResponseEntity.ok(taskCategoryService.getAll());
    }
    ...
    public ResponseEntity<CategoryResponse> create(@Valid @RequestBody CategoryRequest request, HttpServletRequest httpRequest) {
        ...
        return ResponseEntity.ok(taskCategoryService.create(request, userId));
    }
